...
const TimelineItem: React.FC<TimelineItemProps> = ({
  ...
  return (
    ...
    >
      {/* Card Container */}
      <div className="w-full bg-white rounded-3xl p-8 shadow-sm border border-slate-100 hover:shadow-md transition-shadow duration-300 flex flex-col md:flex-row gap-8 items-center md:items-start relative z-10">

        {/* Left Part: Icon & Date */}
        <div className="flex flex-col items-center shrink-0 w-40 border-b md:border-b-0 md:border-r border-slate-100 pb-6 md:pb-0 md:pr-8">
          ...
          <div className="rounded-full px-5 py-2 text-xs font-semibold text-slate-600 whitespace-nowrap uppercase tracking-wide" style={{ backgroundColor: "rgba(1,135,186,0.1)" }}>
            {date}
          </div>
        </div>
